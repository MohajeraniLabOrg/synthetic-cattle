...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file=f'annotations/20kp-{sample_name}-train-fold-{data_batch}.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file=f'annotations/20kp-{sample_name}-val-fold-{data_batch}.json',
        data_prefix=dict(img=f'20kp-{sample_name}-data/'),
        metainfo=dict(from_file='custom-configs/20kp.py'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + f'annotations/20kp-{sample_name}-val-fold-{data_batch}.json')
test_evaluator = [
    dict(
